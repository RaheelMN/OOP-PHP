...
<head>
    ...
    <title>awake magic method</title>
</head>
<body>

    <p>It is called when unserialized function is used.</p>
    <p>unserialized function convert serialized object in string form to object form</p>
    <p>In awake method we can perfom any task</p>
</body>
</html>
