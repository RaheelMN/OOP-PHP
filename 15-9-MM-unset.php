...
<head>
    ...
    <title>unset magic method</title>
</head>
<body>
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
    ...
    <p>Unset removes memory pointer from variable. Memory is later freed</p>
    <p>by garbage collector.</p>
    <p>When we unset a property and it is private or undefined</p>
    <p>then php parser genrates fatal error. To overwrite that error</p>
    <p>we can define our own method to deal with issue.</p>
    <p>It takes name of property as an argument.</p>
</body>
</html>
